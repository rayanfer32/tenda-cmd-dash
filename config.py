...
# settings below are experimental ( DONOT MODIFY )

# REQ_COOKIE only used if stats dont work (use your own cookie) (deprecated)
REQ_COOKIE = None
...
# salts differ based on the local ip  ( deprecated )
SALTS = {
	100:"1qw",
	101:"cvb",
	102:"tgb",
